...
class CompleteAppointments extends StatefulWidget {
  const CompleteAppointments({Key key}) : super(key: key);

  @override
  _CompleteAppointmentsState createState() => _CompleteAppointmentsState();
}

class _CompleteAppointmentsState extends State<CompleteAppointments> {
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                onTap: () {
                                    ...
                                    CompleteAppointmentCon.email=Plist.pname;
                                    CompleteAppointmentCon.email1=Plist.docn.toString();
                                    CompleteAppointmentCon.age=Plist.pAge;
                                    CompleteAppointmentCon.ph=Plist.pmob;
                                    CompleteAppointmentCon.suffer=Plist.remarks;
                                   // CompleteAppointmentCon.appdate=Plist.date as int;
                                    CompleteAppointmentCon.amt=Plist.amut;
                                    CompleteAppointmentCon.city=Plist.pcity;
                                    //Get.to(PatientDetails());
                                    Get.to(() => PatientDetails1());
                                    },
                                child: Card(
                                  child: ListTile(
