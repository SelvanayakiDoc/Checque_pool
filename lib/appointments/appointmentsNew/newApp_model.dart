...
//
//     final newAppModel = newAppModelFromJson(jsonString);

import 'dart:convert';

NewAppModel newAppModelFromJson(String str) => NewAppModel.fromJson(json.decode(str));

String newAppModelToJson(NewAppModel data) => json.encode(data.toJson());
...
class NewAppModel {
  ...
  factory NewAppModel.fromJson(Map<String, dynamic> json) => NewAppModel(
    status: json["status"],
